  ...
  describe('scan', () => {
    it('should scan template directory and find all template files', async () => {
      ...
      mockFiles.forEach(mockFile => {
        ...
        expect(template?.sourcePath).toBe(path.join(templateDir, mockFile.path));
    ...
    it('should skip template pattern files', async () => {
      ...
      const templatePatternFile = templates.find(t => t.relativePath === 'component.template.ts');
  ...
  describe('getTemplatesByCategory', () => {
    it('should return templates filtered by category', async () => {
      ...
      Object.keys(expectedCounts).forEach(category => {
        const templates = scanner.getTemplatesByCategory(category as TemplateCategory);
